...
### v2.0 추가 기능
- **기승전결 구성** — 15곡을 기/승/전/결 흐름으로 자동 배분
- **보컬 설정** — 보컬 있음 / 연주곡 선택
- **BPM 범위 슬라이더** — 최소/최대 BPM 설정 (60~180)
- **곡 길이 선택** — 1분 / 2분 / 3분 / 4분
- **주 악기 선택** — 현악기, 피아노, 기타, 브라스, 전자악기, 타악기
- **레퍼런스 장르** — Lo-fi, Jazz, Classical, Ambient, Bossa Nova, Neo Soul, R&B, Indie Folk, Synthwave, Cinematic, Indie Pop, Dream Pop, Soft Pop, City Pop, Bedroom Pop, Funk, Punk Funk, Disco Funk, G-Funk, Jazz Funk, Afrobeat
- **공간 테마** — 카페, 서재, 침실, 헬스장, 드라이브, 야외
- **계절감** — 봄, 여름, 가을, 겨울
- **배경 사운드** — 비소리, 바람소리, 카페소음, 밤거리, 파도소리, 캠프파이어
- **히스토리** — 생성된 프롬프트 날짜별 저장 및 복사
...
### v2.0 New Features
- **Narrative arc (기승전결)** — automatically distributes 15 tracks across a 4-part intro/build/climax/outro structure
- **Vocal setting** — choose between vocal or instrumental
- **BPM range slider** — set min/max BPM (60–180)
- **Track length selection** — 1 / 2 / 3 / 4 minutes
- **Primary instrument** — Strings, Piano, Guitar, Brass, Electronic, Percussion
- **Reference genres** — Lo-fi, Jazz, Classical, Ambient, Bossa Nova, Neo Soul, R&B, Indie Folk, Synthwave, Cinematic, Indie Pop, Dream Pop, Soft Pop, City Pop, Bedroom Pop, Funk, Punk Funk, Disco Funk, G-Funk, Jazz Funk, Afrobeat
- **Space theme** — Cafe, Study room, Bedroom, Gym, Drive, Outdoor
- **Season** — Spring, Summer, Autumn, Winter
- **Background sound** — Rain, Wind, Cafe ambience, Night streets, Ocean waves, Campfire
- **History** — save and copy generated prompts by date
